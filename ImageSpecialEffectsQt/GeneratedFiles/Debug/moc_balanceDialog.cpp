...
#include "../../../../../../../ÎÄµµ/¹¤³Ì/VC/ImageSpecialEffectsQt/ImageSpecialEffectsQt/balanceDialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_balanceDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 24, 8)
    ...
    "balanceDialog\0accepted\0\0rejected\0"
};
...
void balanceDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        balanceDialog *_t = static_cast<balanceDialog *>(_o);
        switch (_id) {
...
const QMetaObject balanceDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_balanceDialog.data,
      qt_meta_data_balanceDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_balanceDialog.stringdata))
        return static_cast<void*>(const_cast< balanceDialog*>(this));
